...
const achievements = [
  ...
  },
  {
    icon: <BookOutlined />,
    title: "Bookworm",
    desc: "Study for 100+ hours total",
    unlocked: true,
  },
  {
  ...
  },
  {
    ...
    desc: "Maintain 90%+ completion rate",
    unlocked: false,
  },
  {
    icon: <StarOutlined />,
...
const recentActivity = [
  {
    ...
    detail: "Essay: Impact of AI on Education",
    time: "2 hours ago",
    icon: <CheckCircleOutlined />,
  },
  {
    action: "Focus session",
    detail: "Mathematics — 25 min",
    time: "3 hours ago",
    icon: <AimOutlined />,
  },
  {
  ...
  {
    action: "Completed task",
    detail: "Lab Report: Chemical Reactions",
    time: "Yesterday",
    icon: <CheckCircleOutlined />,
  },
  {
    action: "Focus session",
    detail: "Computer Science — 50 min",
    time: "2 days ago",
    icon: <AimOutlined />,
  },
];
...
export default function ProfilePage() {
  ...
  const displayName = userProfile
    ...
    : t.defaultName;
  const university = userProfile?.university || t.defaultUniversity;
  const major = userProfile?.major || t.defaultMajor;
  const semester = userProfile?.semester || t.defaultSemester;
  const joinedAt = userProfile?.joinedAt || "2025-02";
  const initials = `${displayName[0] || "S"}${displayName.split(" ")[1]?.[0] || ""}`
    .trim()
    .toUpperCase();
  ...
  return (
    <div>
      ...
      >
        ...
        >
          ...
          <div style={{ flex: 1 }}>
            ...
            >
              {major} • {semester} {t.semesterLabel}
            </p>
            <div
              style={{
                display: "flex",
      ...
      <div className="grid-2" style={{ marginBottom: "24px" }}>
        ...
        <div
          className="glass-card animate-fade-in"
          style={{ padding: "24px", opacity: 0, animationDelay: "0.1s" }}
        >
          <h2
        ...
        <div
          className="glass-card animate-fade-in"
          style={{ padding: "24px", opacity: 0, animationDelay: "0.15s" }}
        >
          <h2
            style={{ fontSize: "16px", fontWeight: 600, marginBottom: "20px" }}
          >
      ...
      <div
        className="glass-card animate-fade-in"
        style={{ padding: "24px", opacity: 0, animationDelay: "0.2s" }}
      >
        <h2 style={{ fontSize: "16px", fontWeight: 600, marginBottom: "20px" }}>
          {t.enrolledCoursesTitle}
        </h2>
        <div
          style={{
            display: "grid",
