...
export default function ProgressPage() {
  ...
  const tabs = [
    ...
    { value: "semester", label: t.tabs.semester },
  ];
  ...
  return (
    <div>
      ...
      <div className="grid-stats" style={{ marginBottom: "24px" }}>
        {[
          {
            label: t.stats.studyStreak,
            value: "7 days",
            icon: <FireOutlined />,
            color: "#f59e0b",
          },
          {
            label: t.stats.avgFocus,
            value: "45 min",
            icon: <AimOutlined />,
            color: "#6366f1",
          },
          ...
          >
            ...
            >
              ...
              >
                ...
                <span style={{ fontSize: "12px", color: "var(--text-muted)" }}>
                  {t.taskCompletionOf.replace("{total}", "85")}
                </span>
              </div>
            </div>
            <div
            ...
            >
              {[
                {
                  label: t.completionLegend.completed,
                  value: 56,
                  color: "#6366f1",
                },
                {
                  label: t.completionLegend.inProgress,
                  value: 12,
                  color: "#f59e0b",
                },
                {
                  label: t.completionLegend.overdue,
                  value: 5,
                  color: "#ef4444",
                },
                {
                  label: t.completionLegend.upcoming,
                  value: 12,
                  color: "#94a3b8",
                },
              ].map((item) => (
      ...
      <div
        className="glass-card animate-fade-in"
        style={{ padding: "24px", opacity: 0, animationDelay: "0.25s" }}
      >
        <h2 style={{ fontSize: "16px", fontWeight: 600, marginBottom: "20px" }}>
          {t.studyStreakTitle}
        </h2>
